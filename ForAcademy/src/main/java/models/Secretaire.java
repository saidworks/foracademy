...
public class Secretaire extends Utilisateur{
    ...
    public Secretaire(int id_user ,String nom_user, String prenom_user, boolean genre, String telephone, String email, String password, boolean status_user, int id_adress, int id_role ) {
